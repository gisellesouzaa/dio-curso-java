package me.dio.board.service;

import me.dio.board.dtos.BoardColumnInfoDTO;
import me.dio.board.exceptions.CardBlockedException;
import me.dio.board.exceptions.CardFinishedException;
import me.dio.board.exceptions.EntityNotFoundException;
import me.dio.board.persistence.dao.BlockDAO;
import me.dio.board.persistence.dao.CardDAO;
import me.dio.board.persistence.entities.CardEntity;
...
import static me.dio.board.persistence.entities.BoardColumnKindEnum.CANCEL;
import static me.dio.board.persistence.entities.BoardColumnKindEnum.FINAL;
...
public class CardService {
	...
	public void moveToNextColumn(final Long cardId, final List<BoardColumnInfoDTO> boardColumnsInfo)
		...
		try {
			...
			var currentColumn = boardColumnsInfo.stream().filter(bc -> bc.id().equals(dto.columnId())).findFirst()
